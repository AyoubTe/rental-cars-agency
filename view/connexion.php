...
<html>
    ...
    <body>
        <div id="formulaire">
            <div class="container">
                <form method="post" action="../controller/connexion-controller.php?action=connexion">
                    <div>
                        <h2>Connexion</h2>
                        <div class="form-group">
                            <label for="login">Email :</label>
                            <input type="email" class="form-control" id="login" name="login" placeholder="Entrez votre email" required>
                        </div>
                        <div class="form-group">
